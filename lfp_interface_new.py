...
LFP_dir = '/media/HlabShare/Sleep_Scoring/KDR00035/kdr35_02042022/0_9/probe1/co/'
filename = 'H_2022-02-04_08-12-28_2022-02-04_17-07-29_lfp_group0.npy'
start_hour = 0   # different start hour for consecutive blocks; for example: 0-12; 12-24; 24-36
total_hour = 9   # number of hours in each block
lfp_freq = 500
####################
...
for idx, hour in enumerate(np.arange(start_hour,start_hour+total_hour,1)):
    ...
    ntk.ntk_spectrogram(downdatlfp, fs=lfp_freq, nperseg=None, noverlap=None, f_low=1, f_high=64,
                        lsavedir=LFP_dir, hour=hour, chan=None, reclen=3600, lsavedeltathetha=1, probenum=None)
